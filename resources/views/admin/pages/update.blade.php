    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Update / {{$page->id}}</span>
            </div>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="post" action="{{route('page.update',$page->id)}}" >
                            @csrf
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea id="summary-ckeditor" rows="5" cols="5" name="desc" class="form-control">{{$page->desc}}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="seo_title" class="form-control"  placeholder="Meta Title" value="{{$page->seo_title}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Meta Keyword <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="text" name="seo_keyword" class="form-control"  placeholder="Meta Keyword" value="{{$page->seo_keyword}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Meta Description <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <textarea  rows="5" cols="5" name="seo_desc" class="form-control">{{$page->seo_desc}}</textarea>
                                    </div>
                                </div>
                                <div class="float-right">
                                    <button class="btn btn-info mr-2" type="submit">Update Page</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
